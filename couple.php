...
<head>
	...
	<title>Kasal Mo, Plano Ko - Couples</title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Couples</h3>
						</div>
						
		
					</div>
					
					<div class="couple-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'couple' ORDER BY first_name LIMIT $page1,16");
                            $stmt->execute();
                            ...
                            foreach($result as $row)
                            {
								...
								?>
									...
									<div class="couple-grid-item">
											...
											<div class="row gap-10">
												...
												<div class="col-xs-6 col-sm-6">
													<div class="text-right">
														<a class="btn text-right" href="couple-detail.html"><i class="icon-action-redo"></i></a> 
													</div>
												</div>
										...
										<a target="_blank" href="couple-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
											...
											<div class="content">
												...
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $row['city'] ?></p>
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'couple' ORDER BY first_name");
                            $stmt->execute();
                            $result = $stmt->fetchAll();
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="couple.php?page='.$prevpage.'"';} print '><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="couple.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="couple.php?page='.$nextpage.'"';} print '><i class="fa fa-chevron-right"></i></a></li>';
					             }
