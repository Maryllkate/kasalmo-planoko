...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'couple' AND member_no = :empid");
...
<head>
	...
	<title>Kasal Mo, Plano Ko - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="couple.php">All Couples</a></li>
				...
				<div class="container">
					...
					<div class="row">
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="couple-detail-wrapper">
								
									<div class="couple-detail-header text-center">
										...
										<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$mycity"; ?><span class="mh-5">|</span> <i class="fa fa-phone"></i> <?php echo "$myphone"; ?></p>
									...
									<div class="couple-detail-company-overview mt-40 clearfix">
