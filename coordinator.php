...
<head>
	...
	<title>Kasal Mo, Plano Ko - Coordinators</title>
				...
				<div class="container">
						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title">Coordinators</h3>
								</div>
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'coordinator' ORDER BY first_name LIMIT $page1,16");
                            $stmt->execute();
							...
							<h6 class="heading text-primary font700"><?php echo $row['last_name'];?></h6>
							
							<p class="mata-p clearfix"><span class="font13">Show Profile and Packages</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
							</div>
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'coordinator' ORDER BY first_name");
                            $stmt->execute();
                            $result = $stmt->fetchAll();
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="coordinator.php?page='.$prevpage.'"';} print '><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="coordinator.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="coordinator.php?page='.$nextpage.'"';} print '><i class="fa fa-chevron-right"></i></a></li>';
					             }
